...
// binaryTarget url 指向本仓库 GitHub Releases tag 6.0.1 的各 IFLYAd<模块>.xcframework.zip（device ios-arm64 + simulator 双切片），checksum 为其 sha256。
...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "IFLYAdCore",
            url: "https://github.com/LJMcarryu/IFLYADLib_iOS/releases/download/6.0.1/IFLYAdCore.xcframework.zip",
            checksum: "e944daebf26d71f5a2934e5dc84c58ba509758ccfff8a0b3ab6452d3cc58e33a"
        ),
        .binaryTarget(
            name: "IFLYAdVideoUI",
            url: "https://github.com/LJMcarryu/IFLYADLib_iOS/releases/download/6.0.1/IFLYAdVideoUI.xcframework.zip",
            checksum: "8cba386acf1df0e3f067b1ba3f68e069c705910b7825045d8a3691d3bafa9f70"
        ),
        .binaryTarget(
            name: "IFLYAdBanner",
            url: "https://github.com/LJMcarryu/IFLYADLib_iOS/releases/download/6.0.1/IFLYAdBanner.xcframework.zip",
            checksum: "38446ed7d389d9ec5179864b3f34775ed209372e7bd0ee3b04614ad54fc2fe05"
        ),
        .binaryTarget(
            name: "IFLYAdSplash",
            url: "https://github.com/LJMcarryu/IFLYADLib_iOS/releases/download/6.0.1/IFLYAdSplash.xcframework.zip",
            checksum: "f35b90bf50c4454df3cea9a10a97084c35cc9cfa4df9578ef7beac98ae676dee"
        ),
        .binaryTarget(
            name: "IFLYAdInterstitial",
            url: "https://github.com/LJMcarryu/IFLYADLib_iOS/releases/download/6.0.1/IFLYAdInterstitial.xcframework.zip",
            checksum: "d95df610d637cdcdd310d70b8963fa6358914ca56540f2a73dd94156c4043a30"
        ),
        .binaryTarget(
            name: "IFLYAdNativeFeed",
            url: "https://github.com/LJMcarryu/IFLYADLib_iOS/releases/download/6.0.1/IFLYAdNativeFeed.xcframework.zip",
            checksum: "a67548e0d432f4b830826b8cfe7e6c671e998d0823ca9e5676f16a66f195b4e3"
        ),
        .binaryTarget(
            name: "IFLYAdReward",
            url: "https://github.com/LJMcarryu/IFLYADLib_iOS/releases/download/6.0.1/IFLYAdReward.xcframework.zip",
