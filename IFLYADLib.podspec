...
# 对外分发在【公开仓 LJMcarryu/IFLYADLib_iOS】：s.source 指向其 GitHub Releases tag 6.3.0 的合并 zip
...
Pod::Spec.new do |s|
  ...
  s.author = 'LJMcarryu'
  s.source = { :http => 'https://github.com/LJMcarryu/IFLYADLib_iOS/releases/download/6.3.0/IFLYADLib-modelA-6.3.0.zip' }
