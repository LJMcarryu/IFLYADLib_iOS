...
正式签名产物和 7 个 checksum 已冻结并完成本地校验；`IFLYADLib-modelA-6.2.3.zip` 的冻结 SHA-256 为 `b8abe74c5ca3ad244265fb4c5f9c5a466e3d071f74f3d2235cfd16dc4c52d27d`。公开 tag、Release 与匿名消费验证仍须由编排器完成，当前不得作为公开正式版本消费。
