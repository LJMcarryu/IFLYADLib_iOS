...
> **6.2.3 冻结边界**：正式签名资产已从提交 A 构建、冻结并完成本地校验；`IFLYADLib-modelA-6.2.3.zip` 的冻结 SHA-256 为 `1bdb4ed04c2b8f00a9088fa182017e631821b4d32b10ead7e6c3f47f0137ee23`。tag、Release 与匿名消费验证尚未完成，仍待编排器执行，当前 URL 不可用于生产依赖。
