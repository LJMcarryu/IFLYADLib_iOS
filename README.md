...
| 文档版本 | 修订日期 | 修订说明 |
|-------|-------|-------|
| v5.5.1 | 2026-04-14 | 【修复】caid 获取字段为空未过滤的问题<br>【修复】caid 缓存过期未生效的问题 |
| v5.4.8 | 2025-10-20 | 【优化】自定义window无法获取的问题 |
| v5.4.6 | 2025-10-20 | 【优化】获取window方法为nil的问题 |
| v5.4.5 | 2025-09-24 | 【新增】支持5G标识识别<br>【优化】去除点击GIF图表<br>【优化】添加详细的回调注释 |
