...
- 正式签名资产和 7 个 SwiftPM checksum 已冻结并完成本地校验；`IFLYADLib-modelA-6.2.3.zip` 的冻结 SHA-256 为 `7bb36680a29e2b40fdcf182b795add4ca954ff29c44f90cd696562fa0be0e7f0`。tag、Release 与匿名消费验证尚未完成，仍待编排器执行。
